...
export const fetchProductsAsync = createAsyncThunk<Product[], void, { state: RootState }>(
    ...
    async (_, thunkAPI) => 
    {
        ...
        try
        {
            ...
            thunkAPI.dispatch(setMataData(response.metaData));
...
export const catalogSlice = createSlice({
    ...
    reducers: {
        ...
        setMataData: (state, action) =>
        {
            state.metaData = action.payload;
        },
        resetProductParsms: (state) =>
        {
...
export const { setProductsParams, resetProductParsms, setMataData, setPageNumber } = catalogSlice.actions;